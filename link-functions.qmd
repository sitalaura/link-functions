...
::: fragment
**link function** in GLMs transforms (re-map) the linear predictor^[often called $\eta$ - in our example: $\eta = \beta_0 + \beta_1 \cdot age$]
...
su y metti i nomi delle variabili dell'esempio
