...
include-in-header:
  - text: |
      ...
      /* Loghi nella copertina:
         - Psicostat: più grande, leggermente più verso il centro
         - UNIPD: più piccolo, più a destra
      */
      #title-slide::after {
        content: "";
        display: block;
        ...
        background-size:
          180px auto,   /* Psicostat (più grande) */
          450px auto;   /* UNIPD (più piccolo) */
      }
...
::: notes
vediamo graficamente che il modello predice bene i dati nuovi ci permette di predire nuovi outcome compresi tra 0 e 1 e se facciamo lo stesso trick vediamo che il nuovo dataset, viola, presenta valori che stanno nel range di valori possibili per la nostra vd
:::
...
Data simulation, code and presentation are available on GitHub at <a href="https://github.com/sitalaura/link-functions.git" target="_blank">sitalaura/link-functions</a>
...
::: {.column width="55%"}
![](images/logo-UNIPD.bmp){fig-align="center" width="700"}
:::
:::::
